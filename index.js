...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        await tgBot.sendMessage(chatId, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗟𝗘𝗚𝗘𝗡𝗗 𝗠𝗢𝗗 𝗢𝗙𝗙𝗜𝗖𝗘 𝗕𝗢𝗧 | 𝗠𝗔 𝗟𝗘𝗚𝗘𝗡𝗗\n\n𝗘𝗡𝗧𝗘𝗥 𝗬𝗢𝗨𝗥 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗡𝗨𝗠𝗕𝗘𝗥\n(Example: 923000000000)");
        return;
    }
            ...
            if (this.isConnected && this.sock?.user) {
                try {
                    ...
                    await this.sock.sendMessage(botNumber, { 
                        text: "𝗟𝗘𝗚𝗘𝗡𝗗 𝗠𝗢𝗗 𝗢𝗙𝗙𝗜𝗖𝗘 𝗕𝗢𝗧 | 𝗠𝗔 𝗟𝗘𝗚𝗘𝗡𝗗 𝗜𝗦 𝗢𝗡𝗟𝗜𝗡𝗘 🚀\n\n_24/7 Active System Working..._" 
                    });
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("LEGEND MOD OFFICE BOT | MA LEGEND")} 〕━━━┈⊷\n` +
                                                           ...
                                                           `🔗 ${toBold("𝗖𝗛𝗔𝗡𝗡𝗘𝗟:")}\n` +
                                                           `> *https://whatsapp.com/channel/0029VarS46O3QxRtTZO0z60x*\n` +
                                                           `⚡ ${toBold("𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: 𝗟𝗘𝗚𝗘𝗡𝗗 𝗠𝗢𝗗 𝗢𝗙𝗙𝗜𝗖𝗘 𝗕𝗢𝗧 | 𝗠𝗔 𝗟𝗘𝗚𝗘𝗡𝗗")}`;
                                            try {
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("IM USING BEST BOT LEGEND MOD OFFICE BOT | MA LEGEND", 'utf-8') }]
                            });
